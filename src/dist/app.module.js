...
var rooms_module_1 = require("src/rooms/rooms.module");
...
var session_entity_1 = require("src/entities/session.entity");
var message_entity_1 = require("src/messages/entities/message.entity");
var AppModule = /** @class */ (function () {
    function AppModule(dataSource) {
        this.dataSource = dataSource;
    }
    AppModule.prototype.getSessionEntity = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.dataSource.getRepository(session_entity_1.SessionEntity)];
            });
        });
    };
        ...
        common_1.Module({
            imports: [
                ...
                typeorm_1.TypeOrmModule.forRoot({
                    ...
                    type: "postgres",
                    synchronize: true,
                    entities: [user_entity_1.User, rooms_entity_1.Room, message_entity_1.Message, session_entity_1.SessionEntity],
